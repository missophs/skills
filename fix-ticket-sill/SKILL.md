---
name: fix-ticket-sill
description: >
  Alias for fix-ticket-skill. Fix a specific ticket, bug, or issue end-to-end.
  Use when user says "fix this ticket", "resolve this issue", or pastes a ticket
  description and wants it fully addressed.
---
